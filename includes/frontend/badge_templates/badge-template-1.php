...
<div class="wpfrsl-business-wrapper">       
  ...
  <?php if (isset($page_id) && !empty($page_id)) { ?>
    <div class="wpfrs-business-avatar">
  ...
  <div class="wpfrsl-ratings-wrap">
    ...
    <div class="wpfrsl-star-rating">
        ...
        for ($n = 1; $n <= 5; $n++) {
            ...
            <?php if ($half != '') { ?>
                <style type="text/css">
                  .wpfrsl-star-rating .half.wpfrsl-fraction-<?php echo $fraction_percent; ?>::before 
                  {
  ...
  <div class="wpfrsl-review-count">
    <?php esc_attr_e($total_review_count .' Reviews', WPFRSL_TD); ?>
  </div>
